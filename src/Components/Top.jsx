               ...
               <div className="row">
                  <div className="col-sm-12 overflow-hidden">
                     <div className="d-flex align-items-center justify-content-between">
                        <h4 className="main-title">Top 10  Movies In Africa</h4>
               ...
               <div className="favourite-slider">
                  ...
                  <Swiper navigation={true} loop={true} slidesPerView={7}>
                     <ul className="swiper-wrapper p-0 m-0 ">
                        {loading ? (
                             <h4 className="main-title text-danger">Loading Top Movies...</h4>
                        ) : (
                           <>
                           {tops.map((item,index)=>(
                                 ...
                                 <li className="swiper-slide slide-item">
                                    <div className="block-images position-relative ">
                                       ...
                                       <div className="block-description">
                                          <h6 className="iq-title"><a href="show-detail.html" style={{fontSize:12+"px"}}>{item.Title}</a></h6>
