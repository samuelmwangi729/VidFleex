                                ...
                                <ul class="iq-post">
                                    <li>
                                        ...
                                        <div class="post-img-holder">
                                            <a href="#" style={{backgroundImage:"url("+"images/blog/blog1.jpeg"+")"}}></a>
                                        </div>
                                        <div class="post-blog">
                                            <div class="blog-box">
                                                <ul class="list-inline">
                                    ...
                                    <li>
                                        <div class="post-img">
                                        <div class="post-img-holder">
                                            <a href="#" style={{backgroundImage:"url("+"images/blog/blog2.jpeg"+")"}}></a>
                                        </div>
                                        <div class="post-blog">
                                            <div class="blog-box">
                                                <ul class="list-inline">
                                    ...
                                    <li>
                                        <div class="post-img">
                                        <div class="post-img-holder">
                                            <a href="#" style={{backgroundImage:"("+"images/blog/blog3.jpeg"+")"}}></a>
                                        </div>
                                        <div class="post-blog">
                                            <div class="blog-box">
                                                <ul class="list-inline">
